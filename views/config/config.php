...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <hr>
        <?php echo Html::submitButton(Yii::t('QuotesModule.base', 'Save'), array('class' => 'btn btn-primary')); ?>
